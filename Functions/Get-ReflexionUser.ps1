Function Get-ReflexionUser
{
    <#
        .SYNOPSIS
          Get the Reflexion information for users of a specific tenant under your enterprise.

        .DESCRIPTION
          Get the information of all users under your enterprise or under a tenant enterprise. The customer's enterprise ID is a required field in order to pull information from that customer. A specific users information can be queried by specifying their Reflexion UserId, primary smtp address, or name.

        .PARAMETER EnterpriseId
          Specify your organizations enterprise Id or that of a tenant domain. This field is required.
        ...
        .EXAMPLE
          Get-ReflexionCustomerUser -EnterpriseId 12345
   
          Pulls all the uesrs from the customer with an enterprise ID of 12345.

        .EXAMPLE
          Get-ReflexionCustomerUser -EnterpriseId 12345 -UserId 3131

          Pulls the information for the user with an ID of 3131 from the enterprise with an ID of 12345.

        .EXAMPLE
          Get-ReflexionUser -EnterpriseId 12345 -PrimaryAddress "jdoe@bigcompany.com"
    ...
    Try
    {
        ...
        -Uri "https://api.reflexion.net/rfx-rest-api/enterprises/$EnterpriseId/users" -Headers $reflexion_headers
    }
    Catch
    {
